...
{ //Context sinifizda yuklemis oldugumuz identity kutuphanesinin icerdigi tablolari cagiracagiz. 
    ...
    {   //bu class DbContext'in butun ozelliklerini kullanabilir.
        ...
        {
            optionsBuilder.UseSqlServer("server=HOME-PC\\MSSQLSERVER01; Connect Timeout = 30 ; database=TechBlogDb; integrated security=true;TrustServerCertificate=True;");//Bu fonksiyon icin entitiyframework.core.sqlserver yuklenmesi gereklidir. 
        }
